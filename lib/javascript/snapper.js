...
(
	...
	World.prototype = {
	     ...
	     * is a list of snaps that we will add via addSnap.
	     */
		...
		//     alert("World.addSnap: CuAt not found in snap");
		//     return;
		// }
		...
		this.cecs[system_id].addData(snap);
	    }
	};
	...
	CEC.prototype = {
	     ...
	     * CEC.
	     */
	    addData: function (snap) {
		/* Again... mostly for debugging purposes */
		this.snaps.push(snap);

		// var cuats = snap['CuAt'];
		// if (typeof cuats === 'undefined') {
		//     alert("CEC.addData: CuAt not found in snap snap");
		//     return;
		// }
	...
	function Device(lpar, device, snap) {
	    if (this === window) {
		return new Device(lpar, cudv, snap);
	    }
