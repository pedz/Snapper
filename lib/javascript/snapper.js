...
(
	...
	function blahblah(container, target, list) {
	    /*
		...
		mid = ((to_point.y - top_padding) - (target_point.y + bot_padding));
		mid = mid * (index + 1) / max_len;
		...
		mid = ((to_point.y - top_padding) - (target_point.y + bot_padding));
		mid = mid * (blee.length - index) / max_len;
		...
		mid = ((target_point.y - top_padding) - (to_point.y + bot_padding));
		mid = mid * (index + 1) / max_len;
	...
	CEC.prototype = {
		...
		Object.getOwnPropertyNames(this.virtual_switches).forEach(function (virtual_switch_name) {
		    ...
		    blahblah(this, virtual_switch, virtual_switch.connections);
		}, this);
	    },
